...
export default function Contact() {
  return (
    <section id="contact" className="py-28 bg-warm">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          >
            <h2 className="font-serif text-5xl md:text-6xl font-light text-ink leading-tight mb-6">
              Let&apos;s talk
            </h2>
          ...
          >
            {links.map((link) => (
              ...
              >
                ...
                <div>
                  <p className="text-xs text-ink-muted font-medium tracking-wide uppercase mb-0.5">
                    {link.label}
                  </p>
