...
>
  ...
  <div className="relative z-10 text-center px-6">
    ...
    >
      ...
      <a href="https://linkedin.com/in/archit-kiran-kumar-403610243" target="_blank" className="hover:text-blue-400 transition-colors">
        <FaLinkedin />
      </a>
      ...
      >
        ...
        <p className="max-w-3xl text-lg text-gray-300 leading-relaxed">
          Passionate about building scalable web applications, uncovering insights
          through data, and creating seamless user experiences. My work blends{" "}
          <span className="font-semibold">frontend engineering</span> with{" "}
          <span className="font-semibold">data science</span> to turn ideas into
          impactful solutions. Always curious, always learning, that’s my
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-6xl w-full">
          ...
          <div className="rounded-lg bg-gray-800/60 p-6 shadow-lg hover:shadow-xl transition transform hover:scale-105">
            <h3 className="text-2xl font-semibold text-white mb-2">
              Post-Quantum IoT Framework
            </h3>
            <p className="text-gray-300 mb-4">
              Designed a secure IoT communication framework resilient to quantum-computing threats. 
              Integrated post-quantum cryptography techniques while ensuring efficiency for resource-constrained devices.
            </p>
            <a
          ...
          <div className="rounded-lg bg-gray-800/60 p-6 shadow-lg hover:shadow-xl transition transform hover:scale-105">
            ...
            <p className="text-gray-300 mb-4">
              Built a big data pipeline to analyze and visualize urban traffic patterns. 
              Leveraged PySpark and analytics tools to deliver insights for smarter transportation planning.
            </p>
            <a
          ...
          <div className="rounded-lg bg-gray-800/60 p-6 shadow-lg hover:shadow-xl transition transform hover:scale-105">
            ...
            <p className="text-gray-300 mb-4">
              Developed full-stack systems including a Car Rental System and Railway Management System. 
              Built with MongoDB, Express, React, and Node.js, focusing on usability and performance.
            </p>
            <a
      ...
      >
        ...
        <div className="mx-auto max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center">
            <Image src="/Best-Project.jpg" alt="Best Project Award" width={420} height={280} className="rounded-lg shadow-lg object-cover" />
          </div>
          <div className="max-w-xl text-center md:text-left">
            <h3 className="text-3xl font-semibold text-white mb-4">Best Project Award</h3>
            <p className="text-gray-300 text-lg leading-relaxed">
              Won the <span className="font-bold">Best Project Award</span> for an innovative and impactful solution. 
              As part of a four-member team, I contributed ideas, problem-solving, and collaboration alongside Chris Biju, 
              Het Rutul Joshi, and Amogh AN. Together we combined technical depth with real-world applicability, showcasing 
      ...
      >
        <div className="mx-auto max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 max-w-xl text-center md:text-left">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              Represented our project at a <span className="font-bold">national-level exhibition</span>, 
              where we demonstrated scalability and real-world impact to professors, peers, and industry leaders. 
              This experience strengthened my ability to communicate complex ideas clearly and adapt to diverse audiences.
            </p>
          </div>
          <div className="order-1 md:order-2 flex justify-center">
            <Image src="/exhibition.jpg" alt="Exhibition Showcase" width={420} height={280} className="rounded-lg shadow-lg object-cover" />
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center">
            <Image src="/aicte.JPEG" alt="AICTE Program" width={420} height={280} className="rounded-lg shadow-lg object-cover" />
          </div>
          <div className="max-w-xl text-center md:text-left">
            <h3 className="text-3xl font-semibold text-white mb-4">AICTE Program</h3>
            <p className="text-gray-300 text-lg leading-relaxed">
              Contributed to the <span className="font-bold">AICTE program</span>, helping spread computer science knowledge 
              and promoting <span className="italic">environmental cleanliness</span>. I engaged with learners, simplified technical 
              concepts, and encouraged sustainable practices — reinforcing both professional discipline and social responsibility.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <p className="text-gray-300 max-w-xl text-lg mb-8">
          I’m always open to collaborating, sharing ideas, or just connecting with like-minded people. 
